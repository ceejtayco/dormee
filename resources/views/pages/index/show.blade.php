...
<!-- Hero section -->
<section class="hero-section set-bg" data-setbg="{{URL::asset('public/img/bg.jpg')}}" style="background-attachment: fixed; background-size: cover; background-position: right;">
	
	<div class="container hero-text text-white">

		<h2>find your ideal dormitory here with us</h2>
		<p>Search through dormitories that  suit your preferences.<br>You can also use our mobile app to browse for dorms.</p>
		<!-- <a href="#" class="site-btn">VIEW DETAIL</a> -->
		<div class="box-container">
			<div class="box">
				<h3 class="mb-5">Dorm</h3>
				<span class="glyphicon glyphicon-home fa-lg"></span>
			</div>
			<div class="box">
				<h3 class="mb-5">Roommate</h3>
...
<section class="properties-section spad">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="propertie-item set-bg" data-setbg="{{URL::asset('public/img/propertie/1.jpg')}}">
					<div class="rent-notic">Available</div>
					<div class="propertie-info text-white">
						<div class="info-warp">
							<h5>100 Roxas Avenue Dormitory</h5>
							<p><i class="fa fa-map-marker"></i> Roxas Avenue ,Davao 8000, Davao, Philippines</p>
						</div>
						<div class="price">Php 6,000 - Php 12,000 / month</div>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="propertie-item set-bg" data-setbg="{{URL::asset('public/img/propertie/2.jpg')}}">
					<div class="rent-notic">Available</div>
					<div class="propertie-info text-white">
						<div class="info-warp">
							<h5>C5 Dormitel</h5>
						...
						<div class="price">Php 8,000 - Php 19,000 / month</div>
					</div>
				</div>
			</div>
				<!-- <div class="col-md-6">
